...
vector<string> stringSplitter(string input){
	...
	vector<string> strs;
	boost::split(strs, input, boost::is_any_of("/t"));

	// std::istringstream iss(input);
	// vector<string> words{
	// 	istream_iterator<string>(iss), {}
	// };
	//parse(input.begin(), input.end. +qi::alnum % +qi::space, words);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////                     	Extra code, gets too far into areas mapping, out of the scope of Parser     //////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
